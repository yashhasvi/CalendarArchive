  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'language':
        return (
          <div className="space-y-6 max-w-lg mx-auto">
            <h3 className="text-lg font-semibold text-ink-900 dark:text-white">Language & Region</h3>
            <div>
              <label className="block mb-2 text-ink-700 dark:text-ink-300">Preferred Language</label>
              <select className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-ink-900 dark:text-white">
            ...
            <div>
              <label className="block mb-2 text-ink-700 dark:text-ink-300">Region</label>
              <select className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-ink-900 dark:text-white">
      ...
      case 'data':
        return (
          <div className="space-y-6 max-w-lg mx-auto">
            <h3 className="text-lg font-semibold text-ink-900 dark:text-white">Data & Storage</h3>
            <div className="flex flex-col gap-4">
              <button className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors">Download My Data</button>
              <button className="bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition-colors">Delete My Account</button>
            </div>
            <p className="text-ink-500 dark:text-ink-400 text-sm">You can download your data or request account deletion. This action is irreversible.</p>
          </div>
        );
      default:
        return renderProfileTab();
